...
switch choice
    ...
    case 1
        ...
        turb = sum(sum(evalin('base','Plot1Info')== 11))* 1;
        turb = sum(sum(evalin('base','Plot1Info')== 12))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 13))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 14))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 15))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 16))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 17))* 1 + turb;        
        turb = sum(sum(evalin('base','Plot1Info')== 18))* 1 + turb;
        assignin('base','Plot1Turb',turb)
        
        cost = sum(sum(evalin('base','Plot1Info')== 11))* 1 * 999.99 ;
        cost = sum(sum(evalin('base','Plot1Info')== 12))* 1 * 686.40 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 13))* 1 * 399.00 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 14))* 1 * 449.00 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 15))* 1 * 476.93 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 16))* 1 * 749.99 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 17))* 1 * 474.34 + cost ;        
        cost = sum(sum(evalin('base','Plot1Info')== 18))* 1 * 999.98 + cost ;
...
%         power = sum(sum(evalin('base','Plot1Info')== 18)) *1* 50 + power;
        ...
        area = sum(sum(evalin('base','Plot1Info')== 11)) * 1 * 15^2 * pi ;
        area = sum(sum(evalin('base','Plot1Info')== 12)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 13)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 14)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 15)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 16)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 17)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot1Info')== 18)) * 1 * 15^2 * pi + area;
        area = area * 0.0006516;
        assignin('base','Plot1WindArea',area)
                                             
    case 2
        
        turb = sum(sum(evalin('base','Plot2Info')== 11))* 1;
        turb = sum(sum(evalin('base','Plot2Info')== 12))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 13))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 14))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 15))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 16))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 17))* 1 + turb;
        turb = sum(sum(evalin('base','Plot2Info')== 18))* 1 + turb;
        
        assignin('base','Plot2Turb',turb)
        
        cost = sum(sum(evalin('base','Plot2Info')== 11))* 1 * 999.99 ;
        cost = sum(sum(evalin('base','Plot2Info')== 12))* 1 * 686.40 + cost ;        
        cost = sum(sum(evalin('base','Plot2Info')== 13))* 1 * 399.00 + cost ;       
        cost = sum(sum(evalin('base','Plot2Info')== 14))* 1 * 449.00 + cost ;        
        cost = sum(sum(evalin('base','Plot2Info')== 15))* 1 * 476.93 + cost ;        
        cost = sum(sum(evalin('base','Plot2Info')== 16))* 1 * 749.99 + cost ;        
        cost = sum(sum(evalin('base','Plot2Info')== 17))* 1 * 474.34 + cost ;        
        cost = sum(sum(evalin('base','Plot2Info')== 18))* 1 * 999.98 + cost ;
...
%         power = sum(sum(evalin('base','Plot2Info')== 18)) *1* 50 + power;
        ...
        area = sum(sum(evalin('base','Plot2Info')== 11)) * 1 * 15^2 * pi ;
        area = sum(sum(evalin('base','Plot2Info')== 12)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 13)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 14)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 15)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 16)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 17)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot2Info')== 18)) * 1 * 15^2 * pi + area;
        area = area * 0.0006516;
        assignin('base','Plot2WindArea',area)
        
    case 3
        
        turb = sum(sum(evalin('base','Plot3Info')== 11))* 1;
        turb = sum(sum(evalin('base','Plot3Info')== 12))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 13))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 14))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 15))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 16))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 17))* 1 + turb;
        turb = sum(sum(evalin('base','Plot3Info')== 18))* 1 + turb;
        
        assignin('base','Plot3Turb',turb)
        
        cost = sum(sum(evalin('base','Plot3Info')== 11))* 1 * 999.99 ;
        cost = sum(sum(evalin('base','Plot3Info')== 12))* 1 * 686.40 + cost ;        
        cost = sum(sum(evalin('base','Plot3Info')== 13))* 1 * 399.00 + cost ;       
        cost = sum(sum(evalin('base','Plot3Info')== 14))* 1 * 449.00 + cost ;         
        cost = sum(sum(evalin('base','Plot3Info')== 15))* 1 * 476.93 + cost ;        
        cost = sum(sum(evalin('base','Plot3Info')== 16))* 1 * 749.99 + cost ;        
        cost = sum(sum(evalin('base','Plot3Info')== 17))* 1 * 474.34 + cost ;        
        cost = sum(sum(evalin('base','Plot3Info')== 18))* 1 * 999.98 + cost ;
...
%         power = sum(sum(evalin('base','Plot3Info')== 18)) *1* 50 + power;
        ...
        area = sum(sum(evalin('base','Plot3Info')== 11)) * 1 * 15^2 * pi ;
        area = sum(sum(evalin('base','Plot3Info')== 12)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 13)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 14)) * 1 * 13^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 15)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 16)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 17)) * 1 * 10^2 * pi + area;
        area = sum(sum(evalin('base','Plot3Info')== 18)) * 1 * 15^2 * pi + area;
        area = area * 0.0006516;
